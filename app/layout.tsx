  ...
  return (
    <html lang="en" className={`overflow-x-hidden max-w-screen scroll-smooth`}>
      <body className={`overflow-x-hidden max-w-screen ${montserrat.variable} ${montserrat.className} antialiased`} style={{ scrollbarWidth: "none" }} >
        ...
        <Navbar />
        {children}
        <h3 className="text-white text-center min-[1800px]:text-xl">© 2025 DADYAMUN, All Rights Reserved. <br className="sm:hidden" /> <a href="https://emrebozkurt.netlify.app" target="_blank" className="underline cursor-pointer">Emre Bozkurt</a></h3>
        <Analytics />
      </body>
    </html>
  );
