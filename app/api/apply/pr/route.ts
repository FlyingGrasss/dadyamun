...
const SPREADSHEET_ID = process.env.GOOGLE_SHEET_ID_PR!;
...
async function sendVerificationEmail(email: string, name: string, code: string, lang: 'en' | 'tr') {
  try {
    ...
    const emailSubject = lang === 'en' 
      ? 'Verify Your DADYAMUN PR Application' 
      : 'DADYAMUN PR Başvurusu Doğrulama';
  ...
  return lang === 'en' 
    ? `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #172D7F;">DADYAMUN'25 PR Application</h1>
        <p>Dear ${name},</p>
        <p>Thank you for applying to DADYAMUN'25 as a PR!</p>
    ...
    : `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #172D7F;">DADYAMUN'25 PR Başvurusu</h1>
        <p>Sayın ${name},</p>
        <p>DADYAMUN'25'e PR olarak başvurduğunuz için teşekkür ederiz!</p>
...
function generateEmailText(name: string, code: string, lang: 'en' | 'tr'): string {
  return lang === 'en'
    ? `
      DADYAMUN'25 PR Application\n\n
      Dear ${name},\n\n
      Thank you for applying to DADYAMUN'25 as a PR!\n\n
    ...
    `
    : `
      DADYAMUN'25 PR Başvurusu\n\n
      Sayın ${name},\n\n
      DADYAMUN'25'e PR olarak başvurduğunuz için teşekkür ederiz!\n\n
